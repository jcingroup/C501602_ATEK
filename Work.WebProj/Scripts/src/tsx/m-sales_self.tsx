                ...
                <div className="table-filter">
                    <div className="form-inline">
                        <div className="form-group">
                            ...
                            {}
                            <input type="text" className="form-control" onChange={this.changeGDValue.bind(this, 'keyword') } placeholder="請輸入姓名或電話..." />
                            {}
            ...
            onQueryGridData={this.queryGridData} InsertType={this.insertType} deleteSubmit={this.deleteSubmit} />
                ...
                outHtml = (
                    ...
                    <form className="form-horizontal" onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group">
                            <label className="col-xs-2 control-label">階級</label>
                            <div className="col-xs-8">
                                <StateForGird id={fieldData.rank} stateData={DT.SalesRankType} />
                                </div>
                            </div>
                        <div className="form-group">
                            ...
                            <div className="col-xs-8">
                                <div className="input-group">
                                    ...
                                    <span className="input-group-btn">
                                        <button className="btn-info" type="button" onClick={this.openModalShare} disabled={fieldData.edit_type == 1}> <i className="fa-search-plus"></i> { }共享圈成員</button>
                                        </span>
                                    </div>
...
ReactDOM.render(<SalesSelf.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);