...
namespace ProductCategory_l2 {
    interface Rows {
        product_category_l2_id?: string;
        check_del?: boolean,
    ...
    interface FormState<G, F> extends BaseDefine.GirdFormStateBase<G, F> {
        category_option?: Array<server.ProductCategory_l1>
        searchData?: {
            keyword: string
            l1_id: number
        }
    ...
    class GridRow extends React.Component<BaseDefine.GridRowPropsBase<Rows>, BaseDefine.GridRowStateBase> {
        ...
        render() {
            ...
            return <tr>
                       ...
                       <td>{this.props.itemData.category_l1_name}</td>
                       <td>{this.props.itemData.category_l2_name}</td>
    ...
    export class GridForm extends React.Component<BaseDefine.GridFormPropsBase, FormState<Rows, server.ProductCategory_l2>>{
        ...
        constructor() {
            ...
            this.state = {
                ...
                edit_type: 0,
                searchData: { keyword: null, l1_id: null },
                category_option:[]
            }
        }
        static defaultProps: BaseDefine.GridFormPropsBase = {
            fdName: 'fieldData',
            gdName: 'searchData',
            apiPath: gb_approot + 'api/ProductCategoryL2'
        }
        componentDidMount() {
            CommFunc.jqGet(gb_approot + 'Active/Product/aj_l2_Init', {})
                .done((data: Array<server.ProductCategory_l1>, textStatus, jqXHRdata) => {
                    this.setState({
        ...
        deleteSubmit() {
            ...
            for (var i in this.state.gridData.rows) {
                if (this.state.gridData.rows[i].check_del) {
                    ids.push('ids=' + this.state.gridData.rows[i].product_category_l2_id);
                }
            }
        ...
        insertType() {
            this.setState({ edit_type: 1, fieldData: { i_Hide: false, product_category_l1_id: this.state.category_option[0].product_category_l1_id } });
        }
                                    ...
                                    <div className="form-inline">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control"
                                                ...
                                                placeholder="請輸入關鍵字..." /> { }
                                            <label>主分類</label> { }
                                            <select className="form-control" value={searchData.l1_id} onChange={this.changeGDValue.bind(this, 'l1_id') }>
                                                <option value="">全部</option>
                                                {this.state.category_option.map((itemData, i) =>
                                                    <option key={itemData.product_category_l1_id} value={itemData.product_category_l1_id}>{itemData.category_l1_name}</option>) }
                                                </select> { }
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th className="col-xs-3">主分類名稱</th>
                                ...
                                <tbody>
                                    ...
                                    this.state.gridData.rows.map(
                                        (itemData, i) =>
                                            <GridRow key={i}
                                                ikey={i}
                                                primKey={itemData.product_category_l2_id}
                                                itemData={itemData}
        ...
        <div className="col-xs-10">
            ...
            <div className="form-group">
                ...
                <div className="col-xs-8">
                    <select className="form-control" value={fieldData.product_category_l1_id} onChange={this.changeFDValue.bind(this, 'product_category_l1_id') }>
                        {this.state.category_option.map((itemData, i) =>
                            <option key={itemData.product_category_l1_id} value={itemData.product_category_l1_id}>{itemData.category_l1_name}</option>) }
                        </select>
                    </div>
            ...
            <div className="form-group">
                ...
                <div className="col-xs-8">
                    <input type="text" className="form-control" onChange={this.changeFDValue.bind(this, 'category_l2_name') } value={fieldData.category_l2_name} maxLength={32}
                        required />
                    </div>
                <small className="col-xs-2 text-danger">(必填) </small>
                </div>
...
ReactDOM.render(<ProductCategory_l2.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);