...
namespace ProductCategory_l1 {
    ...
    export class GridForm extends React.Component<BaseDefine.GridFormPropsBase, FormState<Rows, server.ProductCategory_l1>>{
        ...
        <div className="col-xs-10">
            <div className="form-group">
                ...
                <div className="col-xs-8">
                    <input type="text" className="form-control" onChange={this.changeFDValue.bind(this, 'category_l1_name') } value={fieldData.category_l1_name} maxLength={32}
                        required />
                    </div>
...
ReactDOM.render(<ProductCategory_l1.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);