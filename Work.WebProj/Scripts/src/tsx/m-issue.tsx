...
namespace Issue {
    ...
    class GridRow extends React.Component<BaseDefine.GridRowPropsBase<Rows>, BaseDefine.GridRowStateBase> {
        ...
        static defaultProps = {
            fdName: 'fieldData',
            gdName: 'searchData',
            apiPathName: gb_approot + 'api/Issue'
        }
        delCheck(i, chd) {
    ...
    export class GridForm extends React.Component<BaseDefine.GridFormPropsBase, FormState<Rows, server.Issue>>{
        ...
        componentDidUpdate(prevProps, prevState) {
            ...
            if ((prevState.edit_type == 0 && (this.state.edit_type == 1 || this.state.edit_type == 2)) ||
                ...
                CKEDITOR.replace('issue_content');
            }
        }
        ...
        handleSubmit(e: React.FormEvent) {
            ...
            e.preventDefault();
            this.state.fieldData.issue_content = CKEDITOR.instances['issue_content'].getData();
        ...
        <div className="col-xs-10">
            <div className="form-group">
                ...
                <div className="col-xs-8">
                    <input type="text" className="form-control" onChange={this.changeFDValue.bind(this, 'issue_title') } value={fieldData.issue_title} maxLength={64}
                        required />
                    </div>
            ...
            <div className="form-group">
                ...
                <div className="col-xs-10">
                    <textarea type="date" className="form-control" id="issue_content" name="issue_content" value={fieldData.issue_content} onChange={this.changeFDValue.bind(this, 'issue_content') } />
                    </div>
                </div>
...
ReactDOM.render(<Issue.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);