...
{
    public class AboutUsDataController : AdminController
    {
        ...
        public string aj_FUpload(string id, string filekind, string fileName)
        {
            ...
            try
            {
                //banner
                if (filekind == "Banner")
                    handleImageSave(fileName, id, ImageFileUpParm.BannerRotator, filekind, "Active", "AboutUsData");
        ...
        public string aj_FList(string id, string filekind)
        {
            ...
            r.files = listImgFiles(id, filekind, "Active", "AboutUsData");
            r.result = true;
            return defJSON(r);
        }
