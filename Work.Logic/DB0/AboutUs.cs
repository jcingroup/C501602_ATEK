...
namespace ProcCore.Business.DB0
{
    ...
    public partial class AboutUs : BaseEntityTable
    {
        public AboutUs()
        {
            this.AboutUsDetail = new HashSet<AboutUsDetail>();
        }
    	...
    	[JsonIgnore]
        public virtual ICollection<AboutUsDetail> AboutUsDetail { get; set; }
    }
}
