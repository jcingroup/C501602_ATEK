...
namespace ProcCore.Business.DB0
{
    ...
    public partial class All_Category_L1 : BaseEntityTable
    {
        public All_Category_L1()
        {
            this.All_Category_L2 = new HashSet<All_Category_L2>();
        }
    	...
    	[JsonIgnore]
        public virtual ICollection<All_Category_L2> All_Category_L2 { get; set; }
    }
}
