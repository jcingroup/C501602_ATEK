...
namespace ProcCore.Business.LogicConect
{
    ...
    public class LogicCenter
    {
        ...
        protected C50A0_ATEKEntities db0;
        protected TransactionScope tx;
        private const string DatabaseName = "C50A0_ATEK";
        ...
        public static C50A0_ATEKEntities getDB0
        {
            get
            {
                return new C50A0_ATEKEntities(db0_connectionstring);
            }
        }
